...
final expectedFirstPageApiCharacters = rawExpectedFirstPageApiCharacters
    .map((character) => Character.fromJson(character))
    .toList();

final expectedFirstPageApiInfo = Info.fromJson(rawExpectedFirstPageApiInfo);

final rawExpectedFirstPageApiInfo = {
  "count": 826,
  "pages": 42,
...
final rawExpectedFirstPageApiCharacters = [
  {
    "id": 1,
    "name": "Rick Sanchez",
    "status": "Alive",
